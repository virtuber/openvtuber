...
def test_filter():
    ...
    assert(f.get_filtered_val((1, 1, 1, 2, 3)) == (1, 1, 1.0, 2.0, 3.0))
    assert(f.get_filtered_val((1, 1, 2, 3, 4)) == (1, 1, 1.5, 2.5, 3.5))
    assert(f.get_filtered_val((1, 1, 2, 3, 4)) == (1, 1, 2.0, 3.0, 4.0))
